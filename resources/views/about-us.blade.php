...
<section class="about-back" style="background-color: ">
    ...
    <div class="container py-5">
        ...
        <div class="row my-5">
            <div class="col-md-6 col-sm-12 px-0 pl-2">
                <h1 class="p-text med-font3 bold  mb-2">{{__('المرأة  العربية تتكلم بصوتٍ عالٍ')}}</h1>
                ...
                <h1 class="p-text   med-font2 ">{{__('تلتزم يونيسف بمنعِ جميع أشكال العنف القائم على أساس الجنس والتصدي لها كجزءٍ من إستجابتها، وتدعم مبادرة (المرأة العربيّة تتكلم) وهي من إعداد لجنة الإنقاذ الدولية في لبنان، التي تُقدم مجموعة من الخدمات التي تهدف الى تعزيز مرونة النساء والفتيات المعرضات للخطر ورفع قدراتهنّ.')}}</h1>
                <h1 class="p-text   med-font2 ">{{__('من خلال توفير بيئة آمنة الى هؤلاء النساء، سيتمكنّ من الإحاطة بخمسة مواضيع رئيسية هي: العنف القائم على أساس نوع الجنس، إحترام الذات والثقة بالنفس، مهارات التفاوض، شبكات الدعم الإجتماعي، والقدرة على اتخاذ القرارات.')}}</h1>
                <h1 class="p-text   med-font2 ">{{__('مبادرة لجنة الإنقاذ الدولية: (المرأة العربية تتكلم) واحدة من سلسلة برامج الدعم النفسي والإجتماعي، صُممت لتمكين تسهيل إكتساب المرأة في هذه البيئة المهارات الحياتية عبر تبادل الخبرات والمعرفة مع أقرانهن. نجح البرنامج في مساعدة النساء على النظرِ الى أنفسهنّ بطريقة مختلفة عن نظرة المجتمع إليهن.')}}</h1>

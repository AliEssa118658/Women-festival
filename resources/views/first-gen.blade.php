...
<section class=""  >
    ...
    <h1 class="bigb-font bold p-text text-center m-auto " >{{__('Honored women from Early pioneers')}}</h1>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12  mb-4 ">
                        ...
                        <div class="card firsts">
                            ...
                            <div class="card-body text-center">
                                <h5 class="med-font2 b-text text-center p-text" style="font-size:20px "  id="title">{{__($first->name)}}</h5>

...
<section  class="mt-5 ">
    <div class="container my-5">
        ...
        @if (app()->getLocale() === 'ar')
            ...
            <p class="med-font3 pl-5 p-text">« ميس عرب سوشيال ميديا »  <br>
                جائزة متزامنة مع المهرجان السنوي للمرأة العربية
    ...
    <div class="overflow-sec">
        <div class="row mb-5 pt-5 justify-content-center">
            <div class="col-md-7 text-center">
                <h1 class="bigb-font bold p-text text-center" >{{ __('Social Media Winners') }}</h1>
            </div>
        </div>

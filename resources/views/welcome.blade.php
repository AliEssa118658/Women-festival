    ...
    <div class="container py-5">
        <div class="row">
            ...
            <div class="col-md-5 col-sm-12 box-vision w-back">
                ...
                <ul style="line-height: 1.5">
                    <li class="p-text med-font2 mb-3 ">{{__('Arab women are the pillar of sustainable human development, and comprehensive development cannot be achieved in our Arab world without the contributions of Arab women and the activation of their role.')}}</li>
                    <li class="p-text med-font2 mb-3">{{__('Arab women have not yet written their history, and in all eras and eras they have played a role in shaping history and the present')}}</li>
                    <li class="p-text med-font2 mb-3">{{__('The Arab woman is the mother, wife, sister, companion and friend of the Arab man, and the relationship between them must be complementary.')}}</li>
                </ul>
            </div>
        </div>
    ...
    <div class="overflow-sec my-5">
        <div class="row  justify-content-center " >
            <div class="col-md-7 text-center">
                <h1 class="bigbig-font bold p-text text-center" >{{ __('Our Events') }}</h1>
            </div>
        </div>
        <div class=" row justify-content-center" style="margin: 4% 3% 4% auto" >
